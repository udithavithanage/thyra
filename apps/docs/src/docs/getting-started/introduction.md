...
Tired of typing long paths or clicking through folders? Thyra lets you:

- **Save time**: Jump to any project in seconds
- **Stay focused**: Keep your hands on the keyboard
- **Work smarter**: No more directory navigation hassle
- **Be productive**: Perfect for developers managing multiple projects
...
- 🛠️ Works with any editor (VS Code, WebStorm, Vim, Sublime Text, Emacs, etc.)
